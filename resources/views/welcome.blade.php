...
<head>
	...
	<!-- Favicon  -->
    <link rel="icon" href="images/photo.png" id="link">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand " href="index.html"><h2 id="logo">BenTech</h2></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>ELECTRO <span id="js-rotating">BUSINESS, SERVICE, SOLUTIONS</span></h1>
                            <p class="p-heading p-large">BenTech is a leading company when it comes to providing Electrical services and Solutions To the Masses</p>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>We Offer Some Of The Best Electrical Business Services In Town</h2>
                        <p> Trying to locate a competent Electrical Engineer can be quite an overwhelming processs at times.</p>
                        <p class="testimonial-text">"Our mission here at BenTech is to get you through those tough moments relying on our team's expertise in Delivering the best"</p>
                        <div class="testimonial-author">Abasiama Benson - CEO</div>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/im1.jpg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Searching for Electrical Engineer</h4>
                            <p>The starting point of any successful Electrical or Electronics Job done is having a Good on the Job </p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>After completing the search the next stage is to design and  plan your work to be done</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>In this phase you will focus on executing the actions plan and evaluating the results after each work completed</p>
                        </div>
                    </div>
                    <!-- end of card -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="images/wiring.jpg" id="img2" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">House Wiring</h3>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos voluptates fugiat quibusdam cupiditate et debitis est illo </p>
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Environment hazard freecare</div>
                                </li>
                                <li class="media">
                                    <i class="fas fa-square"></i>
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="images/im3.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Power Plant Installation</h3>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos voluptates fugiat quibusdam Quos voluptates fugiat</p>
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Lorem ipsum dolor sit amet</div>
                            ...
                            <p class="price">Starting at <span>$256</span></p>
                        </div>
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="#callMe">DETAILS</a>
                        </div> <!-- end of button-container -->
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="images/im4.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Electronics Installation</h3>
                            <p>Quos voluptates fugiat quibusdam ugiat quibusdam ugiat quibusdam ugiat quibusdam</p>
                            <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Lorem ipsum dolor sit amet</div>
	...
	<div id="details" class="accordion">
		<div class="area-1">
            ...
            <div class="accordion-container" id="accordionOne">
                <h2>Accelerate your Electrical Workflow</h2>
                <div class="item">
                    <div id="headingOne">
                        <span data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" role="button">
                            <span class="circle-numbering">1</span><span class="accordion-title">How Can BenTech Help Your Business</span>
                        </span>
                    </div>
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionOne">
                        <div class="accordion-body">
                            At BenTech solutions, we’ve taken the consultancy concept one step further by offering a full service management organization with expertise.
                        </div>
                    </div>
                </div> <!-- end of item -->
                ...
                <div class="item">
                    <div id="headingTwo">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" role="button">
                            <span class="circle-numbering">2</span><span class="accordion-title">Great Strategic wWrk Planning</span>
                        </span>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionOne">
                        <div class="accordion-body">
                            BenTech partners with businesses to business growth and development ideas including environment analysis, plan execution and evaluation.
                        </div>
                    </div>
                </div> <!-- end of item -->
            ...
            <div class="tabs-container">
                ...
                <div class="tab-content" id="ariaTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <h4>Business Services For Companies and Privates owners</h4>
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                        <p><strong>We strive to achieve</strong> 100% customer satisfaction for both types of customers: hiring companies and Private Individual. Types of customers: <a class="green" href="#your-link">with huge potential</a></p>
                        <p><strong>Our goal is to help</strong> you achieve its full potential and establish long term stability for <a class="green" href="#your-link">the business</a></p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Get ready to see results even after only Few days</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a class="popup-with-move-anim img-fluid max-width: 100%" href="#project-1"><div class="element-item-overlay"><span>Circuits Design</span></div><img src="images/electro1.jpg" alt="alternative"style="height:255px;" ></a>
                        </div>
                        <div  class="element-item development">
                            <a  class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Sub-Station Installation</span></div><img src="images/power sta1.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>Power Grid Automation</span></div><img src="images/power sta2.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design development marketing">
                            <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>Circiuts Control Automation</span></div><img src="images/tt.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design development marketing seo">
                            <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>Lorem ipsum dolor.</span></div><img src="images/electro3.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design marketing seo">
                            <a class="popup-with-move-anim" href="#project-6"><div class="element-item-overlay"><span>Lorem ipsum dolor.</span></div><img src="images/electro2.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-7"><div class="element-item-overlay"><span>Lorem ipsum dolor.</span></div><img src="images/power sta4.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                        <div class="element-item design marketing">
                            <a class="popup-with-move-anim" href="#project-8"><div class="element-item-overlay"><span>Lorem ipsum dolor.</span></div><img src="images/power sta5.jpg" alt="alternative" style="height:255px;"></a>
                        </div>
                    </div> <!-- end of grid -->
                    <!-- end of filter -->
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-8">
                <img class="img-fluid" src="images/electro1.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Designing circuits</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a solid Circuits for your Systems? Bentech will help you have a good system that meet your current needs</p>
    ...
    <div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/power sta1.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Well Equip Industry</h3>
                <hr class="line-heading">
                <h6>Strategy Development</h6>
                <p>Need a Great Wiring for your business growth plans? BenTech will help meet your current needs</p>
                <p>By offering the best professional services and quality products in the market. Don't hesitate and get in touch with us.</p>
                <!-- <div class="testimonial-container">
                    <p class="testimonial-text">Need a solid foundation for your business growth plans? Aria will help you manage sales and meet your current requirements.</p>
                    <p class="testimonial-author">General Manager</p>
    ...
    <div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/power sta2.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>BoomBap Audio</h3>
                <hr class="line-heading">
    ...
    <div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/power sta3.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Moose</h3>
                <hr class="line-heading">
    ...
    <div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/electro3.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Joy Moments</h3>
                <hr class="line-heading">
    ...
    <div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/electro2.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Spark Events</h3>
                <hr class="line-heading">
    ...
    <div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/power sta4.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Casual Wear</h3>
                <hr class="line-heading">
    ...
    <div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
            <div class="col-lg-8">
                <img class="img-fluid" src="images/power sta5.jpg" alt="alternative">
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>Zazoo Apps</h3>
                <hr class="line-heading">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="address"><i class="fas fa-map-marker-alt"></i>uyo, Akwa Ibom, Nigeria</li>
                            <li><i class="fas fa-phone"></i><a href="tel:00">+234</a></li>
                            <li><i class="fas fa-phone"></i><a href="tel:00">+234</a></li>
                            <li><i class="fas fa-envelope"></i><a href="ma">YourEmail</a></li>
                        </ul>
                        <h3>Follow Bentech On Social Media</h3>
